...
export default function BannerManagement({ onAdd, onEdit, onDeleteRequest }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-100 dark:border-neutral-800 shadow-sm overflow-hidden transition-colors">
      <div className="px-[10px] py-8 md:p-8 border-b border-gray-100 dark:border-neutral-800 flex flex-wrap gap-4 justify-between items-center bg-gray-50/30 dark:bg-neutral-800/30">
        <div>
        ...
        <button
          type="button"
          onClick={onAdd}
          className="flex items-center gap-2 bg-black text-white px-5 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-800 transition-all active:scale-95 cursor-pointer flex-shrink-0"
        >
